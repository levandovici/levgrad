...
// min shape density to justify detail sampling - below this the detail erosion
// will almost certainly push density to zero, wasting expensive 3D texture fetches
#define VOLUMETRIC_DETAIL_MIN_NOISE_VALUE 0.05

// additional LOD increase based on distance-squared from camera
// distant clouds subtend fewer pixels, so lower detail is acceptable
#define VOLUMETRIC_LOD_DISTANCE_MULTIPLIER 2.0
...
(
	...
	lerp(0.0, 0.7, WM_CAMERA_RENDER_MODE_CUBEMAP)
));
...
(1.0 * WM_CAMERA_RENDER_MODE_CUBEMAP);
